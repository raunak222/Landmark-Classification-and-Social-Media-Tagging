...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose([transforms.Resize(256),
             ...
             transforms.RandomChoice([transforms.ColorJitter(hue=0.1),
        ...
        "valid": transforms.Compose(
            [transforms.Resize(256),transforms.RandomResizedCrop(224),transforms.ToTensor(),transforms.Normalize(mean,std)]
        ),
    ...
    test_data = datasets.ImageFolder(
        base_path / "test",data_transforms["test"]
    )
